...
public class TestSetPays {
    public static void main(String[] args) {
        ...
        Collections.addAll(setPays,
                new Pays("Etat-Unis", 333_300_000, 76_329.6),
                new Pays("France", 68_000_000, 46_125.3),
                new Pays("Allemagne", 83_000_000, 48_718),
                new Pays("Royaume-Uni",  67_000_000, 46_125.3),
        ...
        // Mettre en majuscule le nom du pays dont le PIB total est le plus élevé
        paysMaxPIBTot.setNom(paysMaxPIBTot.getNom().toUpperCase());
